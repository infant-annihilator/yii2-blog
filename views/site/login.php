...
<div class="container center-screen">
    ...
    <div class="form w-30 text-center">
        ...
        <h3 class="logo-auth">Авторизация</h3>
        ...
        <?= Html::submitButton('Войти', ['class' => 'btn btn-my bg-transparent w-100 mt-4 mb-4', 'name' => 'login-button']) ?>

        <span class="faggot">Забыли пароль</span>
